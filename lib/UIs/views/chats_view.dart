import 'package:whatsap_clone/UIs/widgets/chats_desktop_view.dart';
import 'package:whatsap_clone/UIs/widgets/chats_mobile_view.dart';
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ChatsViewModel>.reactive(
      ...
      builder: (context, model, _) {
        if (Orientations.maxWidth(context) > 500) {
          model.windows = true;
          model.mobile = false;
        } else {
          model.mobile = true;
        ...
        return Scaffold(
          appBar: model.mobile
              ? AppBar(
                  elevation: 0,
                  backgroundColor: Colors.grey.withOpacity(0.003),
                  title: const Text(
                    'Edit',
